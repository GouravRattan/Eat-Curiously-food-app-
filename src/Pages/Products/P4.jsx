...
import pieces4 from '../../assets/sub-product-img/image4.png';
            ...
            <div className="flex bg-[#042f1a] h-screen ">
                ...
                <div className="flex flex-col justify-center items-center w-1/2 text-white ml-20">
                    ...
                    <div className='flex flex-col w-1/4 gap-y-4 mr-[600px]'>
                        <button
                            type="submit"
                            className=" bg-[#E25B77] text-[#042f1a] text-2xl font-bold font-rammetto rounded-md p-3 cursor-pointer"
                        >
                            ADD TO CART
                        </button>
                ...
                <div className="w-1/2 flex justify-end items-center">
                    <img src={pieces4} alt="About" className="mr-40 mt-10 w-[700px] object-contain rounded-xl" />
                </div>
            </div>
        </>
    );

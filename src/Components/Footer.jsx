...
const Footer = () => {
  return (
    <>
    <div className=' bg-[#fc74b4] text-teal-950 mb-20 '>
      <div className="flex justify-center items-center">
    <img className='h-auto flex justify-center items-center' src={FooterImg} alt="footer-img" />
    </div>
      <footer
  class="flex flex-col items-center text-center text-surface dark:bg-neutral-700 bg-[#fc74b4]">
  <div class="container px-6 pt-6">
   
    <div>
      <form action="">
        <div
          class="gird-cols-1 grid items-center justify-center gap-80 md:grid-cols-3">

<div class="relative md:mb-6 ">
            <input
              type="text"
              class="peer h-10 bg-white block min-h-[auto] w-full rounded border-0 bg-transparent px-3 py-[0.32rem] leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 peer-focus:text-primary data-[twe-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-white dark:placeholder:text-neutral-300 dark:autofill:shadow-autofill dark:peer-focus:text-primary [&:not([data-twe-input-placeholder-active])]:placeholder:opacity-0"
    ...
    <div class="mb-6 font-rammetto font-bold text-6xl ">
      <p>
        FEED ME MORE
      </p>
    </div>
